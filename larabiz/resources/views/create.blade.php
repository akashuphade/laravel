                ...
                <div class="card-body">
                    <form method="POST" action="/listings">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="website" type="url" class="form-control @error('website') is-invalid @enderror" name="website" value="{{ old('website') }}" placeholder="Enter your website" autocomplete="website">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <textarea name="bio" id="bio" class="form-control @error('bio') is-invalid @enderror" value="{{ old('bio') }}" placeholder="Enter your bio" row=3></textarea>
